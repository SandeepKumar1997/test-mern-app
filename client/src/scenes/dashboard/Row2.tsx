      ...
      <DashboardBox gridArea="e">
        ...
        <FlexBetween mt="0.25rem" gap="1.5rem" pr="1rem">
          ...
          <Box ml="-0.7rem" flexBasis="40%" textAlign="center">
            ...
            <Typography variant="h6" color={palette.primary[300]} m="0.3rem 0">
              85
            </Typography>
            <Typography variant="h6">Finance goals</Typography>
          </Box>

          <Box flexBasis="40%">
            <Typography variant="h5">Losses in revenue</Typography>
            <Typography variant="h6">Losses are down by x%</Typography>
